        ...
        >
          <div className="grid grid-cols-form gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              <InputRoot>
                <InputControl id="firstName" defaultValue="Natally" />
              </InputRoot>
              <InputRoot>
                <InputControl defaultValue="Riqueto" />
              </InputRoot>
            </div>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <InputRoot>
              ...
              <InputControl
                id="email"
                type="email"
                defaultValue="natallyriqueto@hotmail.com"
              />
            </InputRoot>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            >
              ...
              <span className="mt-0.5 block text-sm font-normal text-zinc-500">
                This will be displayed on your porfile.
              </span>
            </label>
